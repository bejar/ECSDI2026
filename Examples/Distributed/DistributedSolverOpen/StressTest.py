...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--n", default=100, type=int, help="Numero de iteraciones del test"
    )
    parser.add_argument(
        "--cport", default=None, help="Puerto del cliente que recibe las respuestas"
    )
    parser.add_argument(
    ...
    for i in range(args.n):
        ...
        if "OK" in solveradd:
            ...
            resp = requests.get(
                solveradd + "/message", params={"message": mess}, timeout=5
            ).text
